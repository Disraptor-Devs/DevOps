...
Introduction
The infrastructure configuration in this repository is designed to provision and manage various SNS topics in AWS. It includes resources for managing log groups related to Lambda functions, DocumentDB, API Gateway, AWS Backup, and S3 buckets.
