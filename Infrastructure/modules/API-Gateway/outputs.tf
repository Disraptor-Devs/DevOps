output "api_gateway_id" {
  ...
  value       = var.is_create_api_gateway ? aws_api_gateway_rest_api.api_gateway[0].id : data.aws_api_gateway_rest_api.existing_api_gateway[0].id
}

output "api_gateway_root_resource_id" {
  description = "Output the API Gateway root resource id"
  value       = var.is_create_api_gateway ? aws_api_gateway_rest_api.api_gateway[0].root_resource_id : data.aws_api_gateway_rest_api.existing_api_gateway[0].id
}
