...
| <a name="input_kinesis_stream_arn"></a> [kinesis\_stream\_arn](#input\_kinesis\_stream\_arn) | specify the kinesis stream arn to be procided in the extended s3 config | `string` | `null` | no |
...
| <a name="input_lambda_processor_arn"></a> [lambda\_processor\_arn](#input\_lambda\_processor\_arn) | Specify The lambda processor arn for the extended S3 configuration if process configuration has been enabled | `string` | `null` | no |
...
| <a name="input_redshift_passw"></a> [redshift\_passw](#input\_redshift\_passw) | Specify the value of the redshift password to be used for the redshift config | `string` | `null` | no |
| <a name="input_redshift_usernmae"></a> [redshift\_usernmae](#input\_redshift\_usernmae) | Specify the value of the redshift username for the reshift config | `string` | `null` | no |
